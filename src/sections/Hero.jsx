          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground max-w-xl">
                ...
                — a software engineer specializing in React, JavaScript,
                Node.js, and Python. I build scalable, performant web
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <AnimatedBorderButton
                href="https://github.com/nandan099"
                className="group"
              >
                View Projects
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <a
                href="https://www.linkedin.com/in/nandan-reddy-1111102b7/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full border border-border hover:border-primary hover:text-primary transition-all duration-300"
              >
